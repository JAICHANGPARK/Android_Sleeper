...
public class TalkActivity extends AppCompatActivity implements TextToSpeech.OnInitListener {
        ...
        chatBarView.setSendClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (chatBarView.getMessageText().equals("")) {
                    ...
                    BackgroundTask myClientTask = new BackgroundTask(address, iPort, chatBarView.getMessageText());
                    myClientTask.execute();
                }
        ...
        protected void onPostExecute(Void result) {
            ...
            switch (audioManager.getRingerMode()){
                case AudioManager.RINGER_MODE_VIBRATE:
                    // TODO: 2017-10-18 진동모드 처리
                    break;
                case AudioManager.RINGER_MODE_SILENT:
                    // TODO: 2017-10-18 무음 모드 처리
                    break;
                case AudioManager.RINGER_MODE_NORMAL:
                    // TODO: 2017-10-18 소리 모드 처리
        ...
        switch (requestCode) {
            case REQ_CODE_SPEECH_INPUT: {
                if (resultCode == RESULT_OK && data != null) {
                    ...
                    BackgroundTask myClientTask = new BackgroundTask(address, iPort, result.get(0));
                    myClientTask.execute();
    ...
    private void speakOut() {
        // TODO: 2017-10-18 진동모드가 되어도 소리가 나는 현상이 있어서 불편했음. 해결해보자.
        // TODO: 2017-10-18 함수가 실행될때마다 상태 값을 받아오자.
        audioManager = (AudioManager)getSystemService(Context.AUDIO_SERVICE);
        switch (audioManager.getRingerMode()){
            case AudioManager.RINGER_MODE_VIBRATE:
                // TODO: 2017-10-18 진동모드 처리 
